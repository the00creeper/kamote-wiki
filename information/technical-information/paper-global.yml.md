...
{% code title="paper-global.yml" fullWidth="false" %}
```yml
_version: 30
anticheat:
  obfuscation:
...
proxies:
  bungee-cord:
    online-mode: [CLASSIFIED]
  proxy-protocol: [CLASSIFIED]
  velocity:
    enabled: [CLASSIFIED]
    online-mode: [CLASSIFIED]
    secret: ''
...
spam-limiter:
  incoming-packet-threshold: [CLASSIFIED]
  recipe-spam-increment: [CLASSIFIED]
  recipe-spam-limit: [CLASSIFIED]
  tab-spam-increment: [CLASSIFIED]
  tab-spam-limit: [CLASSIFIED]
spark:
