...
{% code title="paper-world-defaults.yml" fullWidth="false" %}
```yml
_version: 31
anticheat:
  anti-xray:
    enabled: true
    engine-mode: [CLASSIFIED]
    hidden-blocks:
    - [CLASSIFIED]
    lava-obscures: [CLASSIFIED]
    max-block-height: [CLASSIFIED]
    replacement-blocks:
    - [CLASSIFIED]
    update-radius: 2
...
entities:
  ...
  spawning:
    ...
    duplicate-uuid:
      mode: [CLASSIFIED]
      safe-regen-delete-range: [CLASSIFIED]
    filter-bad-tile-entity-nbt-from-falling-blocks: [CLASSIFIED]
